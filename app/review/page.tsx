    ...
    <AppShell>
      <div className="flex flex-col gap-6 max-w-2xl mx-auto py-2">
        ...
        <div className="flex items-center justify-between">
          ...
          {totalCount > 0 && (
            <span className="rounded-full bg-amber-500/10 px-3 py-1 text-xs font-bold text-amber-400 ring-1 ring-amber-500/20">
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center rounded-3xl border border-zinc-800/80 bg-zinc-900/40 p-10 text-center shadow-xl">
            <div className="flex h-16 w-16 items-center justify-center rounded-3xl bg-amber-500/10 text-amber-400 ring-1 ring-amber-500/20 mb-4">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Link
                href="/random"
                className="flex items-center gap-1.5 rounded-xl bg-amber-500 px-5 py-2.5 text-xs font-semibold text-zinc-950 hover:bg-amber-400 transition-all active:scale-95 shadow-sm"
              >
                Try Random Recall
              </Link>
              <Link
          ...
          <div className="flex flex-col rounded-3xl border border-zinc-800 bg-zinc-900/70 shadow-2xl backdrop-blur-xl overflow-hidden">
            ...
            <div className="mt-6 border-t border-zinc-800/80 pt-4">
              <button
                ...
                className="flex w-full items-center justify-between rounded-xl bg-zinc-950/80 px-4 py-3 text-xs font-semibold text-zinc-300 hover:bg-zinc-950 transition-colors border border-zinc-800/60"
              >
                <span>{isContentRevealed ? 'Hide Note Content' : 'Reveal Note Content'}</span>
                {isContentRevealed ? <ChevronUp className="h-4 w-4 text-zinc-500" /> : <ChevronDown className="h-4 w-4 text-zinc-500" />}
              </button>
            ...
            <div className="mt-8 grid grid-cols-2 gap-4 border-t border-zinc-800/80 pt-6">
              ...
              >
                ...
                <span className="text-[10px] text-red-400/60">Reset to 1 day</span>
              </button>
              ...
              <button
                ...
                disabled={reviewMutation.isPending}
                className="flex flex-col items-center justify-center gap-1 rounded-2xl bg-amber-500 py-3.5 px-4 text-center transition-all hover:bg-amber-400 active:scale-[0.98] disabled:opacity-50 group shadow-lg shadow-amber-500/10"
              >
                <div className="flex items-center gap-1.5 text-sm font-bold text-zinc-950">
                  <Check className="h-4 w-4 stroke-[3]" />
                  Remembered
                </div>
                <span className="text-[10px] text-zinc-950/70 font-medium">Advance stage</span>
              </button>
            </div>
            </div>
          </div>
